...
public class ProgramTypes {
        ...
        public static final HashMap<String, VariableType> userTypes = new HashMap<>();
        ...
        public void fillInteger() {
                ...
                Integer.methods.put("toReal",
                                new MethodDeclaration("toReal", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Integer.methods.put("toBoolean",
                                new MethodDeclaration("toBoolean", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Integer.methods.put("UnaryMinus",
                                new MethodDeclaration("UnaryMinus", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));

                Integer.methods.put("Plus",
                                new MethodDeclaration("Plus", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));
                Integer.methods.put("Minus",
                                new MethodDeclaration("Minus", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));
                Integer.methods.put("Mult",
                                new MethodDeclaration("Mult", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));
                Integer.methods.put("Div",
                                new MethodDeclaration("Div", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Integer.methods.put("Rem",
                                new MethodDeclaration("Rem", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));
                Integer.methods.put("Less",
                                new MethodDeclaration("Less", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Integer.methods.put("LessEqual",
                                new MethodDeclaration("LessEqual", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Integer.methods.put("Greater",
                                new MethodDeclaration("Greater", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Integer.methods.put("GreaterEqual",
                                new MethodDeclaration("GreaterEqual", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Integer.methods.put("Equal",
                                new MethodDeclaration("Equal", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
        }
        ...
        private void fillReal() {
                ...
                Real.methods.put("toInteger",
                                new MethodDeclaration("toInteger", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));
                Real.methods.put("UnaryMinus",
                                new MethodDeclaration("UnaryMinus", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Real.methods.put("Plus",
                                new MethodDeclaration("Plus", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Real.methods.put("Minus",
                                new MethodDeclaration("Minus", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Real.methods.put("Mult",
                                new MethodDeclaration("Mult", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Real.methods.put("Div",
                                new MethodDeclaration("Div", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
                Real.methods.put("Rem",
                                new MethodDeclaration("Rem", new ArrayList<>(), new ReturnType("Real"),
                                                new ArrayList<>()));
        ...
        private void fillBoolean() {
                ...
                Boolean.methods.put("Or",
                                new MethodDeclaration("Or", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Boolean.methods.put("And",
                                new MethodDeclaration("And", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Boolean.methods.put("Xor",
                                new MethodDeclaration("Xor", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
                Boolean.methods.put("Not",
                                new MethodDeclaration("Not", new ArrayList<>(), new ReturnType("Boolean"),
                                                new ArrayList<>()));
        }

        private void fillArray() {
                Array.methods.put("toList",
                                new MethodDeclaration("toList", new ArrayList<>(), new ReturnType("List"),
                                                new ArrayList<>()));
                Array.methods.put("Length",
                                new MethodDeclaration("Length", new ArrayList<>(), new ReturnType("Integer"),
                                                new ArrayList<>()));
                Array.methods.put("get",
                                new MethodDeclaration("get", new ArrayList<>(), new ReturnType("null"),
                                                new ArrayList<>()));
                Array.methods.put("set",
                                new MethodDeclaration("set", new ArrayList<>(), new ReturnType("null"),
                                                new ArrayList<>()));
        }

        private void fillList() {
                List.methods.put("append",
                                new MethodDeclaration("append", new ArrayList<>(), new ReturnType("null"),
                                                new ArrayList<>()));
                List.methods.put("head",
                                new MethodDeclaration("head", new ArrayList<>(), new ReturnType("null"),
                                                new ArrayList<>()));
                List.methods.put("tail",
                                new MethodDeclaration("tail", new ArrayList<>(), new ReturnType("null"),
                                                new ArrayList<>()));
